    ...
    <div class="container-scroller">
                ...
                <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
                    <div class="ps-lg-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 font-weight-medium me-3 buy-now-text">Download ENKPAY Mobile app on both App
                                stores, </p>
                            <a href="https://playstore.com" target="_blank"
                                class="btn me-2 buy-now-btn border-0">Andriod</a>
                            <a href="https://iosstore.com" target="_blank" class="btn me-2 buy-now-btn border-0">IOS</a>

                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="https://enkwave.com/"><i class="mdi mdi-home me-3 text-white"></i></a>
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="/agent-dashboard"><img
                        src="{{url('')}}/public/assets/images/logo.png" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="/agent-dashboard"><img
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                            ...
                            <div class="nav-profile-img">
                                <img src="{{url('')}}/public/assets/images/logo-mini.png" alt="image">
                    ...
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="{{url('')}}/public/assets/images/logo-mini.png" alt="profile">
                                <span class="login-status online"></span>
                                <!--change to offline or busy as needed-->
                            </div>
                            <div class="nav-profile-text d-flex flex-column">
                                <span class="font-weight-bold mb-2">{{Auth::user()->first_name}}
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="general-pages">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/update-account"> Update account</a>
                                </li>
                            </ul>
                        </div>
                    </li>
