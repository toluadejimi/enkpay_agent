...
<div class="main-panel">
    <div class="content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right">
                                <p class="mb-0 text-right">Total Money In</p>
                ...
                <div class="card card-statistics">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right">
                                <p class="mb-0 text-right">Weekly Money In</p>
                                <div class="fluid-container">
                                    <h3 class="font-weight-medium text-right mb-0">NGN {{number_format($money_week), 2 }}
                                    </h3>
                                </div>
                            </div>
                        </div>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="pills-pos-tab" data-bs-toggle="pill" data-bs-target="#pills-pos"
                    type="button" role="tab" aria-controls="pills-pos" aria-selected="false">Card Transactions</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Bank Transfer</button>
            </li>
