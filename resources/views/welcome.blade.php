    ...
    <div class="container">
        <section class="login-clean"
            ...
            @csrf
                ...
                <div class="mb-3"><input class="form-control" type="text"  value="+234" name="phone"
                        required ></div>
                <div class="mb-3"><input class="form-control" type="password" name="password" required  placeholder="Password"
                ...
                <a class="forgot" href="forgot-password.html">Forgot your password?</a>
