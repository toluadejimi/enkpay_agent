...
<div class="main-panel">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number"  name ="amount" class="form-control form-control-lg" placeholder="Enter your amount" aria-label=" ">
                      <p> Min NGN 100  | Max 1,000,000.00</p>
                    </div>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="row">
        ...
        <div class="form-group pt-3">   
                      ...
                      <input type="text" class="form-control form-control-lg" disabled value="{{  Auth::user()->bank_name  }}">
                    </div>
        </div>
        <div class="col-xs-6">
    ...
    <div class="form-group pt-3">   
                      ...
                      <input type="text" class="form-control form-control-lg" disabled value="{{  Auth::user()->account_number  }}">
                    </div>
    </div>
    <div class="col-md-4">
    <div class="form-group pt-3">   
                      <label>Account Name</label>
                      <input type="text" class="form-control form-control-lg" disabled value="{{  Auth::user()->account_name  }}">
                    </div>
    </div>    
  </div>
</div>
